...
Follow the [style guide](content/style-guide/index.md) when making changes to documentation or tutorials. The [top 12 guidelines](content/style-guide/top-12.md) covers the most common use cases. 
