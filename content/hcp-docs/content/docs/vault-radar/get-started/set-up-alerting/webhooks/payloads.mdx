...
|---------------------|-----------|---------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `version`           | `string`  | Webhook payload version. Payload may vary between versions                                                                                                                                       |
| `event_id`          | `string`  | Unique identifier for the event                                                                                                                               |
| `type`              | `string`  | High level type for the event                                                                                                                                 |
| `sub_type`          | `string`  | Subtype for the event                                                                                                                                |
...
| `details`           | `string`  | Additional metadata about the finding                                                                                                                          |
| `severity`          | `string`  | Severity label for the finding                                                                                                                                |
| `risk_category`     | `string`  | Risk category assigned by Radar                                                                                                                               |
| `secret_activeness` | `string`  | Indicates whether the secret is active                                                                                                                        |
...
| `resource_name`     | `string`  | Name of the resource within the data source (for example, repository name)                                                                                    |
| `resource_uri`      | `string`  | URI of the resource within the data source                                                                                                                    |
| `visibility`        | `string`  | Visibility of the resource (for example, public or private)                                                                                                   |
...
| `content_id`        | `string`  | Identifier for the content unit (for example, commit hash) associated with the finding                                                                        |
| `content_reference` | `string`  | Reference to the content (for example, git branch or tag) associated with the finding                                                                         |
