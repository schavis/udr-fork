...
description: >-
  Add Slack as a data source for Vault Radar to monitor your Slack channels for sensitive data and secrets.
...
Connect Slack as a data source to HCP Vault Radar to monitor your Slack channels
