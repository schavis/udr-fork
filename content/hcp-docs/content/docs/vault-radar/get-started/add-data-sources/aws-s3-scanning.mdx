...
- `s3:GetBucketPolicyStatus`, `s3:GetBucketAcl`, `s3:GetBucketPublicAccessBlock` and `s3:GetObjectAcl`: Scans without these optional permissions do not include visibility values of the bucket or the detected secrets.
