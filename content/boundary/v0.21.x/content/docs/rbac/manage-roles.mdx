...
- For more specific information about the roles resource, refer to the [roles domain model](/boundary/docs/domain-model/roles) topic.
- To learn more about using the CLI to create or manage roles, refer to the [`roles`](/boundary/docs/commands/roles) topic.
- To learn more about using the API to create or manage roles, refer to the [role service](/boundary/api-docs/role-service) topic.
