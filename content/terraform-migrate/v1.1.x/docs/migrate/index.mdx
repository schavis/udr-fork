...
1. Enable [logging](#enable-logging) so that you can troubleshoot potential issues that may occur during the migration process.
...
The `tf-migrate` tool can create CLI- or VCS-driven HCP Terraform workspaces. 
