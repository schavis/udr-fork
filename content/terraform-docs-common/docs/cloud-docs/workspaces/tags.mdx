...
- You must be member of a team with the **Admin** permission group enabled for the workspace to delete tags on a workspace or member of a team with Organizational Access **Manage all workspaces** (allows tag management on any workspaces).
