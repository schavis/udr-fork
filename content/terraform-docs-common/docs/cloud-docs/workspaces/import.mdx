...
If you environment connects to HCP Terraform using an HCP Terraform agent, you must enable the `query` operation when starting the agent pool. Refer to [Install and run agents](/terraform/cloud-docs/agents/agents) for more information.
