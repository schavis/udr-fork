...
To update the state of a deployment, update your Stack configuration files and apply the corresponding deployment runs to update the state of each deployment. You cannot manually affect the state of a Stack deployment without updating your configuration.
...
- [Remove components](/terraform/language/stacks/components/manage#remove-components)
- [Update the resources in the module](/terraform/language/stacks/components/manage#manage-resources) that a `component` block sources
