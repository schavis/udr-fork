...
1. There are a number of **Advanced options** that alow you to control the behavior of the stack
    ...
    * Version control settings:
      ...
      * With a branch-based workflow, you can configure **Trigger patterns** to control which file changes trigger new operations.
