...
1. Use **Advanced options** to control the behavior of your Stack:
    ...
    * Version control settings:
      ...
      * With a branch-based workflow, you can configure **Trigger patterns** to control which file changes trigger new runs.
