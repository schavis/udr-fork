...
To learn how to set permissions for a project, refer to [Set roles in HCP Terraform](/terraform/cloud-docs/users-teams-organizations/permissions/set-permissions).
