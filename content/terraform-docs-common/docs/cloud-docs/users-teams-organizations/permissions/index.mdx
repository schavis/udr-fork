...
In an HashiCorp Cloud Platform (HCP) Europe organization, you manage user access through groups. To learn more, refer to [Use HCP Terraform in Europe](/terraform/cloud-docs/europe). To learn how to set up groups and assign users to them in HCP, refer to [Groups](/hcp/docs/hcp/iam/groups).
