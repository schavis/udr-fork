...
- Organization owners or members with [**Manage public providers** permissions](/terraform/cloud-docs/users-teams-organizations/permissions/organization#manage-public-registry) can add or remove GPG keys.
- Organization [owners](/terraform/cloud-docs/users-teams-organizations/permissions/organization#organization-owners) can release an organization’s claim on a namespace.
...
1. Click **New GPG Key**, which only appears to those with [**Manage public providers** permissions](/terraform/cloud-docs/users-teams-organizations/permissions/organization#manage-public-registry).
