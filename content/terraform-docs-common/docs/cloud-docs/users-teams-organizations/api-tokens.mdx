...
Group API tokens may belong to a specific group. Group API tokens allow access to the workspaces that the group has access to, without being tied to any specific user.
