...
If you are in an HashiCorp Cloud Platform (HCP) Europe organization, you manage user access through groups.

@include 'eu/org-is-eu.mdx'

To learn how to set up groups and assign users to them in HCP, refer to [Groups](/hcp/docs/hcp/iam/groups).
