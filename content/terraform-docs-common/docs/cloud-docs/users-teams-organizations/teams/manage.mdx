...
If you are in an HashiCorp Cloud Platform (HCP) Europe organization, you manage user access through groups. To learn how to set up groups and assign users to them in HCP, refer to [Groups](/hcp/docs/hcp/iam/groups). To learn how to assign roles to your groups, refer to [Set roles](/terraform/cloud-docs/users-teams-organizations/permissions/set-roles).
