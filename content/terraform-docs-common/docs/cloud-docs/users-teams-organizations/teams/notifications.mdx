...
You can configure an individual team notification to notify up to twenty teams. To set up notifications for teams using the API, refer to the [Team notification configurations API reference](/terraform/cloud-docs/api-docs/notification-configurations/team).
...
A generic notification contains information about the event that triggered it and the time that the event occurred. You can refer to the complete generic notification payload in the [API documentation](/terraform/cloud-docs/api-docs/notification-configurations/team#notification-payload).
