...
At this point, GitHub access for HCP Terraform is fully configured, and you can create Terraform workspaces or Stacks based on your organization's shared GitHub Enterprise repositories.
