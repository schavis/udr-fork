...
This means that different HCP Terraform or Terraform Enterprise users within the same organization can see different sets of repositories available for their workspaces or Stacks.
