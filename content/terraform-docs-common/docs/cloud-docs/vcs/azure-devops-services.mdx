...
After configuring Azure DevOps Services access for HCP Terraform, you can create Terraform workspaces or Stacks based on your organization's repositories.
