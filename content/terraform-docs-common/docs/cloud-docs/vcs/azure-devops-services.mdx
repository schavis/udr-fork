...
After configuring Azure DevOps Services access for HCP Terraform or Terraform Enterprise, you can create workspaces or Stacks based on your organization's repositories.
