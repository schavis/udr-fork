---
page_title: Organize infrastructure with Stacks and workspaces in HCP Terraform
description: |-
...
A [workspace](#TODO) contains one Terraform root module, one set of inputs, and one state file. We recommend using workspaces if your use case meets any of the following conditions:
