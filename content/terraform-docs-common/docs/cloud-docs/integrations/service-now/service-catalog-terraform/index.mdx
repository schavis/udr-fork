...
In HashiCorp Cloud Platform (HCP) Europe organizations, you cannot use any ServiceNow integrations. To learn more about HCP Europe, refer to [Use HCP Terraform in Europe](/terraform/cloud-docs/europe).
