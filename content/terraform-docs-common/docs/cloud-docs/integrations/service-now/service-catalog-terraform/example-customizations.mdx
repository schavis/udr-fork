...
1. If there is an **Approval Step** in your flow. Open the "Ask for Approval" Action, and customize it by adding your approver and/or a due date.
   It is important to note that this approver must have the role **"approver_user"** in order to approve requests.
