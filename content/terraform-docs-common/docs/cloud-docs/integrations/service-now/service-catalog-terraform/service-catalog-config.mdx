...
We recommend that you customize the approval flow with the appropriate approver. Refer to the [example customizations](/terraform/cloud-docs/integrations/service-now/service-catalog-terraform/example-customizations#Make-a-copy-of-the-existing-Catalog-Item)for more details.