...
After you've added a provider to the registry, you can assign tags so that you can apply consistent metadata to registry artifacts. You can also use tags to gate access to specific providers and versions. Refer to [Manage artifact tags](/terraform/cloud-docs/registry/manage/tags) for more information.
