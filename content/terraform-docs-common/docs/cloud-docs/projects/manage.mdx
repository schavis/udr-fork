...
In HashiCorp Cloud Platform (HCP) Europe organizations, you cannot set execution mode at the project-level. Instead, you can set an execution mode at the [organization](/terraform/cloud-docs/users-teams-organizations/organizations/settomgs#general) or [workspace](/terraform/cloud-docs/workspaces/settings#execution-mode) level. To learn more about HCP Europe, refer to [Use HCP Terraform in Europe](/terraform/cloud-docs/europe).
