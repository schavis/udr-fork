...
In HashiCorp Cloud Platform (HCP) Europe organizations, you create and manage projects through the the HCP platform. HCP Terraform inherits projects and their settings from HCP. To learn how to manage projects in HCP, refer to [Projects](/hcp/docs/hcp/admin/projects).
...
In HashiCorp Cloud Platform (HCP) Europe organizations, you cannot set execution mode at the project level. Instead, you can set an execution mode at the [organization](/terraform/cloud-docs/users-teams-organizations/organizations#general) or [workspace](/terraform/cloud-docs/workspaces/settings#execution-mode) level.
