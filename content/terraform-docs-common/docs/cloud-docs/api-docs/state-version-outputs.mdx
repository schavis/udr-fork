...
<!-- BEGIN: TFC:only name:stacks-tfe --> If you are using a Stack and want to interact with Stack deployment state, refer to [deployment state](#TODO). <!-- END: TFC:only name:stacks-tfe -->
