...
| `data.relationships.stacks`           | array   | `[]`                                                   | Array of references to stacks that the variable set should be assigned to.                                                                   |                                                                                         
...
| `data.relationships.stacks`     | array   |         | **Optional** Array of references to stacks that the variable set should be assigned to. Sending an empty array clears all stack assignments.         |
...
Accepts a list of stacks to add the variable set to.
