...
| `filter[allowed_stacks][name]`     | **Optional.** Filters agent pools to those associated with the given stack. The stack must have permission to use the agent pool. Refer to [Scoping Agent Pools to Specific Stacks](/terraform/cloud-docs/agents#scope-an-agent-pool-to-specific-stacks). |
...
| `data.relationships.allowed-stacks.data.type` | string |         | Must be `"stacks"`.                                                                                                                                                                    |
| `data.relationships.allowed-stacks.data.id`   | string |         | The ID of the stack that has permission to use the agent pool. Refer to [Scoping Agent Pools to Specific Stacks](/terraform/cloud-docs/agents#scope-an-agent-pool-to-specific-stacks).  |
...
| `data.relationships.excluded-stacks.data.type`   | string |         | Must be `"stacks"`.                                                                                                                                                                    |
| `data.relationships.excluded-stacks.data.id`     | string |         | The ID of the stack that is excluded from the scope of the agent pool.  |
...
| `stacks`       | The stacks attached to this agent pool.     |
