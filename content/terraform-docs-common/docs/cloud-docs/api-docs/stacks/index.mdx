...
Stacks represent collections of components, replicated across one or more deployments. To learn more, refer to the [Stacks overview](/terraform/cloud-docs/stacks).
