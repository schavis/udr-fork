...
* Update existing [organization documentation](/terraform/cloud-docs/users-teams-organizations/organizations/index) to include references to the new agent pool scoping options.
* Update existing [projects documentation](/terraform/cloud-docs/agents/projects/) to include new `default-execution` flow.
* Update existing [agent pools documentation](/terraform/cloud-docs/agents/agent-pools) to include new agent pool scoping options, including adding allowed projects and adding exclusions for workspaces.
