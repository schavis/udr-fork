...
Project notifications allow you to configure notifications for an entire project instead of setting them up for individual workspaces. Project notifications apply to every workspace in the project.
