...
description: >-
<<<<<<< HEAD:content/terraform-docs-common/docs/cloud-docs/api-docs/notification-configurations/workspace.mdx
...
>>>>>>> main:content/terraform-docs-common/docs/cloud-docs/api-docs/notification-configurations.mdx
---
