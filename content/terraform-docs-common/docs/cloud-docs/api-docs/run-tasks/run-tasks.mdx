...
You may also configure the run task to begin during specific [run stages](/terraform/cloud-docs/workspaces/run/states). Run tasks use the [Post-Plan Stage](/terraform/cloud-docs/workspaces/run/states#the-post-plan-stage) by default.
