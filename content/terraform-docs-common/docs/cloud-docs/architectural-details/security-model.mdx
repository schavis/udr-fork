...
If you are using [HCP Terraform in Europe](/terraform/cloud-docs/europe), some features described in this document may not be available. To learn more, refer to [Use HCP Terraform in Europe](/terraform/cloud-docs/europe).
...
If you are using an HCP Europe organization, there is no organization owners team because you manage users with HCP groups. To learn more about HCP EU, refer to [Use HCP Terraform in Europe](/terraform/cloud-docs/europe).
...
To learn how to assign permissions at different scopes, refer to [Set permissions with roles](/terraform/cloud-docs/users-teams-organizations/permissions/set-roles).
