...
[Practical, implementation-focused content. When helpful, include the who/when/why to provide context. If it is clear from reading the content who/when/where, then you do not need to explicitly add it. Focus on how to implement the practice.]
...
## [Another action-oriented section header]

[Additional practical content, implementation guidance, or advanced considerations. Keep sections focused and concise.]
...
- **Concise sections** - 2-3 main sections maximum, keep content focused and atomic
...
- **Avoid excessive headers** - Too many headers break reading flow and make articles too long
