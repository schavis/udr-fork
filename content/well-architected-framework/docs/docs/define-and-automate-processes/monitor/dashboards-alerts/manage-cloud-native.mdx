...
In this section of [Configure dashboards and alerts](/well-architected-framework/define-and-automate-processes/monitor/dashboards-alerts), you found resources to help you use Terraform to define and manage dashboards and alerts on your preferred cloud vendor. Configuring dashboards and alerts is part of the [Define and automate processes pillar](/well-architected-framework/define-and-automate-processes).