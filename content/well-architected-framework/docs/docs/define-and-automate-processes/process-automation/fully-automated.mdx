...
In this section of [Automation maturity model](/well-architected-framework/define-and-automate-processes/process-automation), you learned best practices for implementing fully-automated deployments. Automation maturity model is part of the [Define and automate processes pillar](/well-architected-framework/define-and-automate-processes).