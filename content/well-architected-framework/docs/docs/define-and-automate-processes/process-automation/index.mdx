...
- [Semi-automated deployments - Start here if you're currently doing manual deployments](/well-architected-framework/define-and-automate-processes/process-automation/semi-automated)
- [Fully-automated deployments - Start here if you're currently doing semi-automated deployments](/well-architected-framework/define-and-automate-processes/process-automation/fully-automated)