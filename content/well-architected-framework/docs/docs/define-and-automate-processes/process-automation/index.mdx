...
In this overview of the automation maturity model, you learned the benefits and tradeoffs of different automation levels, and where your organization is in the model. Visit the following documents to learn specifics on semi and fully-automated deployments. The automation maturity model is part of the [Define and automate processes pillar](/well-architected-framework/define-and-automate-processes).

- [Semi-automated deployments](/well-architected-framework/define-and-automate-processes/process-automation/semi-automated)
- [Fully-automated deployments](/well-architected-framework/define-and-automate-processes/process-automation/fully-automated)