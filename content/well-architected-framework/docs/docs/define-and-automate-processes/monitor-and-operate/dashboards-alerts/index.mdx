...
- [Manage vendor monitoring tools](/well-architected-framework/define-and-automate-processes/monitor-and-operate/dashboards-alerts/manage-vendor)
- [Manage cloud native monitoring tools](/well-architected-framework/define-and-automate-processes/monitor-and-operate/dashboards-alerts/manage-cloud-native)