...
In this section of [Configure dashboards and alerts](/well-architected-framework/define-and-automate-processes/monitor-and-operate), you found resources to help you configure OTel on your services and manage vendor monitoring tools with Terraform. Configuring dashboards and alerts is part of the [Define and automate processes pillar](/well-architected-framework/define-and-automate-processes).