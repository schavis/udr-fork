...
In this section of [Setup monitoring agents](/well-architected-framework/define-and-automate-processes/monitor-and-operate/setup-monitoring-agents), you learned how to configure and deploy monitoring agents on virtual machines. Setting up monitoring agents is part of the [Define and automate processes pillar](/well-architected-framework/define-and-automate-processes).