...
- [Manage vendor monitoring tools](/well-architected-framework/define-and-automate-processes/monitor-and-operate/dashboard-alerts/manage-vendor)
- [Manage cloud native monitoring tools](/well-architected-framework/define-and-automate-processes/monitor-and-operate/dashboard-alerts/manage-cloud-native)