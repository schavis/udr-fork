...
- [Setup monitoring agents](/well-architected-framework/define-and-automate-processes/monitor-and-operate/setup-monitoring-agents) to collect metrics and logs.
- [Configure dashboards and alerts](/well-architected-framework/define-and-automate-processes/monitor-and-operate/dashboard-alerts) to view the metrics and notify you of issues.