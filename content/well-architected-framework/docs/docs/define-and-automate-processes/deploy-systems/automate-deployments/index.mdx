...
In this overview of Automate deployments, you learned the benefits and tradeoffs of the automation maturity model, and where your organization is in the model. Visit the following documents to learn specifics on semi and fully-automated deployments. Automated deployments is part of the [Define and automate processes pillar](/well-architected-framework/define-and-automate-processes).

- [Semi-automated deployments](/well-architected-framework/define-and-automate-processes/deploy-systems/automate-deployments/semi-automate)
- [Fully-automated deployments](/well-architected-framework/define-and-automate-processes/deploy-systems/automate-deployments/fully-automate)