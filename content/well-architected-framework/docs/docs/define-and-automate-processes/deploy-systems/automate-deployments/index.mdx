...
description: Implement automated deployment strategies to reduce manual errors, improve consistency, and enable faster, more reliable application delivery.
---
...
In this overview of Automate deployments, you learned the benefits and tradeoffs of the automation maturity model, and where your organization is in the model. Visit the following documents to learn specifics on semi and fully-automated deployments. Automated deployments is part of the [Automate and define processes pillar](/well-architected-framework/automate-and-define-processes).

- [Semi-automated deployments](/well-architected-framework/automate-and-define-processes/develop-and-deploy/automate-deployments/semi-automate)
- [Fully-automated deployments](/well-architected-framework/automate-and-define-processes/develop-and-deploy/automate-deployments/fully-automate)