...
In this section of [Automate deployments](/well-architected-framework/define-and-automate-processes/deploy-systems/automate-deployments), you learned best practices for implementing semi-automated deployments. Automate deployments is part of the [Define and automate processes pillar](/well-architected-framework/define-and-automate-processes).