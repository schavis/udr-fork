...
In this section of [Develop applications](/well-architected-framework/define-and-automate-processes/build-and-test/setup-application), you learned how to deploy your applications using Terraform, Kubernetes, or Nomad. Develop applications is part of the [Define and automate processes pillar](/well-architected-framework/define-and-automate-processes).