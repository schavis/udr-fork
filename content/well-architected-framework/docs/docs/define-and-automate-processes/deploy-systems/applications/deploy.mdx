...
description: Deploy applications using infrastructure as code to container orchestrators or virtual machines with immutable infrastructure patterns.
---
...
In this section of [Deploy systems](/well-architected-framework/define-and-automate-processes/deploy-systems), you learned how to deploy your applications using Terraform, Kubernetes, or Nomad. Deploy systems is part of the [Define and automate processes pillar](/well-architected-framework/define-and-automate-processes).