...
description: Implement comprehensive monitoring for applications and infrastructure to enable service discovery, traffic management, and issue resolution.
---
...
In this section of [Develop applications](/well-architected-framework/define-and-automate-processes/build-and-test/setup-application), you learned how to monitor your applications and infrastructure. Develop applications is part of the [Define and automate processes pillar](/well-architected-framework/define-and-automate-processes).