...
In this section of [Develop applications](/well-architected-framework/define-and-automate-processes/build-and-test/setup-application), you learned how to package your application into a deployable artifact, such as a virtual machine image or Docker container. Develop applications is part of the [Define and automate processes pillar](/well-architected-framework/define-and-automate-processes).