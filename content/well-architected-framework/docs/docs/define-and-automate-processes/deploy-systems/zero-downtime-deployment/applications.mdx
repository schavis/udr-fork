...
In this section of [Zero-downtime deployments](/well-architected-framework/define-and-automate-processes/deploy-systems/zero-downtime-deployment), you learned about methods to deploy application changes with zero-downtime. Zero-downtime deployments is part of the [Define and automate processes pillar](/well-architected-framework/define-and-automate-processes).
