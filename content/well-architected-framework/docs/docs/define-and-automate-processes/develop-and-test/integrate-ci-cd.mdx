...
In this section of [Develop applications](/well-architected-framework/define-and-automate-processes/build-and-test/setup-application), you learned best practices for integrating your deployments into a CI/CD pipeline. Develop applications is part of the [Define and automate processes pillar](/well-architected-framework/define-and-automate-processes).