---
page_title: Use development environment
...
In this section of [Develop and test](/well-architected-framework/define-and-automate-processes/develop-and-test), you learned how to create consistent development environments to avoid inconsistencies between development and production. Develop and test is part of the [Define and automate processes pillar](/well-architected-framework/define-and-automate-processes).