...
In this section of [Develop applications](/well-architected-framework/define-and-automate-processes/build-and-test/setup-application), you learned how to create consistent development environments to avoid inconsistencies between development and production. Develop applications is part of the [Define and automate processes pillar](/well-architected-framework/define-and-automate-processes).