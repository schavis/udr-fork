---
page_title: Codify systems and tools
...
- [CI/CD systems](/well-architected-framework/define-and-automate-processes/develop-and-test/codify-systems-and-tools/ci-cd)
- [Cloud automation](/well-architected-framework/define-and-automate-processes/develop-and-test/codify-systems-and-tools/cloud-automation)
- [Container orchestration](/well-architected-framework/define-and-automate-processes/develop-and-test/codify-systems-and-tools/container-orchestration) like Kubernetes, Nomad, and cloud-native container services
- [Databases](/well-architected-framework/define-and-automate-processes/develop-and-test/codify-systems-and-tools/database)
- [Logging and monitoring](/well-architected-framework/define-and-automate-processes/develop-and-test/codify-systems-and-tools/logging-and-monitoring)
- [Security and authentication](/well-architected-framework/define-and-automate-processes/develop-and-test/codify-systems-and-tools/security-and-authentication)
- [Version control systems](/well-architected-framework/define-and-automate-processes/develop-and-test/codify-systems-and-tools/version-control-systems) like GitHub, GitLab, and Bitbucket
