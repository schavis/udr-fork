...
- [Continuous integration/deployment (CI/CD) systems](/well-architected-framework/define-and-automate-processes/use-infrastructure-as-code/ci-cd)
- [Public cloud and cloud automation](/well-architected-framework/define-and-automate-processes/use-infrastructure-as-code/cloud-automation)
- [Container orchestration](/well-architected-framework/define-and-automate-processes/use-infrastructure-as-code/container-orchestration) like Kubernetes, Nomad, and cloud-native container services
- [Database systems and components](/well-architected-framework/define-and-automate-processes/use-infrastructure-as-code/database)
- [Logging and monitoring](/well-architected-framework/define-and-automate-processes/use-infrastructure-as-code/logging-and-monitoring)
- [Security and authentiation](/well-architected-framework/define-and-automate-processes/use-infrastructure-as-code/security-and-authentication)
- [Version control systems (VCS)](/well-architected-framework/define-and-automate-processes/use-infrastructure-as-code/version-control-systems) like GitHub, GitLab, and Bitbucket
