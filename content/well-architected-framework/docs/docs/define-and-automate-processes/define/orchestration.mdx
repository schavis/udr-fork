...
In this overview, you learned how to define your container orchestration platforms using infrastructure as code to establish consistent container management processes.
...
- [Automate your workflows](/well-architected-framework/define-and-automate-processes/automate/) to deploy your orchestration platforms
- [Automate your workflows](/well-architected-framework/define-and-automate-processes/automate/) to deploy applications to your orchestration platforms
