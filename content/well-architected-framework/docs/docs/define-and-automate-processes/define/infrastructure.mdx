...
In this overview, you learned how to define your infrastructure systems using infrastructure as code to establish a foundation for automation.
...
- Topics in **Automate your workflows**
  ...
  - [Deployment](/well-architected-framework/define-and-automate-processes/automate/deployment) - Implement deployment for infrastructure and applications
