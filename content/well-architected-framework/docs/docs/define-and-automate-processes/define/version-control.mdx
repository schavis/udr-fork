...
In this section, you learned how to implement version control for infrastructure configuration to enable collaboration, change tracking, and rollback capabilities.

Refer to the following documents to learn more about version control and automation:

- [Automate your workflows](/well-architected-framework/define-and-automate-processes/automate/) to integrate version control with CI/CD pipelines
