...
In this overview, you learned how to define your CI/CD infrastructure using infrastructure as code to establish consistent CI/CD processes.
...
- [Automate your workflows](/well-architected-framework/define-and-automate-processes/automate/) to deploy your CI/CD infrastructure
- [Deploy with confidence](/well-architected-framework/define-and-automate-processes/deploy/) to connect CI/CD with application deployment
