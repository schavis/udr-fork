...
In this section of [Define your processes](/well-architected-framework/define-and-automate-processes/define/), you learned how to create consistent development environments to avoid inconsistencies between development and production. Define your processes is part of the [Define and automate processes pillar](/well-architected-framework/define-and-automate-processes).