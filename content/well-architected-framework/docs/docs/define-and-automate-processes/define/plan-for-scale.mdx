---
page_title: Implement automated scaling
description: Implement automated scaling strategies to handle varying capacity and traffic demands while maintaining cost control and system reliability.
---
...
- [Scale resources](/well-architected-framework/optimize-systems/scale-resources)
...
In this section, you learned how to implement automated scaling strategies to handle varying capacity and traffic demands while maintaining cost control and system reliability.

Refer to the following documents to learn more about scaling and optimization:

- [Monitor system health](/well-architected-framework/optimize-systems/monitor-system-health) to track your infrastructure performance
- [Scale resources](/well-architected-framework/optimize-systems/scale-resources) for additional scaling strategies
- [Automate your workflows](/well-architected-framework/define-and-automate-processes/automate/) to implement automated scaling processes