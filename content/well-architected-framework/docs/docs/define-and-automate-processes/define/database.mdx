...
In this overview, you learned how to define your database systems using infrastructure as code to establish consistent database management processes.
...
- [Automate your workflows](/well-architected-framework/define-and-automate-processes/automate/) to deploy your database systems
- [Automate your workflows](/well-architected-framework/define-and-automate-processes/automate/) to connect applications to your databases
