...
In this section of Define your processes, you learned about using Terraform modules to standardize your infrastructure deployments. Create reusable infrastructure modules is part of the [Define and automate processes pillar](/well-architected-framework/define-and-automate-processes/define).
