...
In this section of Define your processes, you learned how to identify and document your current manual processes to establish a foundation for automation. Map your current workflows workflows is part of the [Define and automate processes pillar](/well-architected-framework/define-and-automate-processes/define).
