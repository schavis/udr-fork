...
In this section of how to [secure data](/well-architected-framework/secure-systems/data), you learned about how to secure and encrypt data in transit using HashiCorp Vault to encrypt data before writing it to the applications primary storage service and how to use HashiCorp Consul to encrypt data between services using a service mesh. In the next section, you will learn more about how to [protect data at rest](/well-architected-framework/secure-systems/data/protect-data-at-rest)
