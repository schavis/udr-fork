...
In this section of how to [secure data](/well-architected-framework/secure-systems/data), you learned about how to tokenize your data using HashiCorp Vault Enterprise. In the next section, you will learn how to [securely store static secrets with Vault](/well-architected-framework/secure-systems/secrets/store-static-secrets).
