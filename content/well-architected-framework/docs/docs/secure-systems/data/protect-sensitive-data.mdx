...
In this section of how to [secure data](/well-architected-framework/secure-systems/data), you learned about common ways to secure sensitive data using HashiCorp Vault, HCP Vault Radar, and Consul. In the next section, you will learn more about how to [protect data in transit](/well-architected-framework/secure-systems/data/protect-data-in-transit).
