...
In this section of how to [secure data](/well-architected-framework/secure-systems/data), you learned about why it is important to create, and apply a data classification scheme in your organization. Classifying your data is a key step to ensure your data is properly secured. In the [protect data in transit section](/well-architected-framework/secure-systems/data/protect-data-in-transit) you will learn how to protect sensitive data such as data classified as restricted, or confidential.
