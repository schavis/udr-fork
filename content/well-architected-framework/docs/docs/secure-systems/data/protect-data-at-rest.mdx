...
In this section of how to Secure data, you learned about how to secure and encrypt data at rest using HashiCorp Vault. In the next section, you will learn more about how to enhance data security by [tokenizing your data with Vault Enterprise](/well-architected-framework/secure-systems/data/tokenize-data).
