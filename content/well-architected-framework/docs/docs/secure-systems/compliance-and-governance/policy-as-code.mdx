...
![Sentinel SCM](/img/docs/well-architected/sentinel-waf.png)
...
In this section of how to [Compliance and governance](/well-architected-framework/secure-systems/compliance-and-governance/overview), you learned how you can use policy as code to enforce rules using IaC and Terraform. Compliance and governance is part of the [Secure systems pillar](/well-architected-framework/secure-systems/introduction).