...
In this section of how to [Compliance and governance](/well-architected-framework/secure-systems/compliance-andgovernance//overview), you learned how you can use policy as code to enforce rules using IaC and Terraform. Compliance and governance is part of the Secure systems pillar.