...
In this section of Secure applications, you learned how to manage TLS certificates using infrastructure as code tools like Terraform and the TLS provider. You also learned how to use ACME for automated certificate management. Secure applications is part of the [Secure systems pillar](/well-architected-framework/secure-systems).
