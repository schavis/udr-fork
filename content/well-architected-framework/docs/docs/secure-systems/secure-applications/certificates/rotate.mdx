...
In this section of Security and compliance, you learned about rotating expired certificates. Security and compliance is part of the [Secure systems pillar](/well-architected-framework/secure-systems).