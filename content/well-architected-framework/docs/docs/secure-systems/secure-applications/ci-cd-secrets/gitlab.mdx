...
![GitLab Vault workflow](/img/docs/well-architected/gitlab-vault-workflow.png)
...
In this section of [managing CI/CD secrets](content/well-architected-framework/secure-systems/secure-applications/ci-cd-secrets/overview), you learned about GitLab and Vault integration. GitLab and Vault integration is part of the [Secure systems pillar](/well-architected-framework/secure-systems).