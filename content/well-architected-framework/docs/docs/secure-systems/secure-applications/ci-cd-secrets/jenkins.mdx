...
In this section of [managing CI/CD secrets](content/well-architected-framework/secure-systems/secure-applications/ci-cd-secrets/overview), you learned about Jenkins and Vault integration. Jenkins and Vault integration is part of the [Secure systems pillar](/well-architected-framework/secure-systems/introduction).