...
![Vault Workflow](/img/docs/well-architected/vault-cicd-1.png)
...
- [CI/CD anti-patterns](/well-architected-framework/secure-systems/secure-applications/ci-cd-secrets/ci-cd-anti-patterns)
