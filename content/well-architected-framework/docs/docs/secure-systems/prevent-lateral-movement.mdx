...
![Anatomy of a cyber attack](/img/well-architected/anatomy-cyber-attack-1.png)
...
![Service Mesh 101](/img/well-architected/service-mesh-1.png)
...
![Secret sprawl](/img/well-architected/secret-sprawl-1.png)
...
- [Identify, prevent, and manage leaked secrets](/well-architected-framework/security/security-identify-protect-leaked-secrets)
