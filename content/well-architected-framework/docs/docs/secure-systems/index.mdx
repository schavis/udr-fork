...
description: Learn how to implement comprehensive security controls for your infrastructure and applications.
---
...
This pillar covers six main areas that work together to create comprehensive system security:

- **Identity and access management** provides the foundation for controlling access to resources and protecting sensitive information, including authentication, authorization, and role-based access control.

- **Secrets management** covers the secure storage and distribution of sensitive credentials and configuration, including automatic rotation, access control, and audit logging.

- **Data security** focuses on protecting data throughout its lifecycle, including encryption, access controls, and data classification for data at rest and in transit.

- **Secure applications** covers building security into the development process, including secure coding practices, vulnerability management, and application security testing.
...
- **Network security** provides protection against network-based threats and unauthorized access, including network segmentation, firewalls, and intrusion detection systems.

### Identity and access management

Identity and access management is the foundation of security. Without proper authentication and authorization, all other security controls are ineffective since you cannot control who has access to your systems and data. This section covers user management, role-based access control, identity federation, and multi-factor authentication practices. These practices help you implement robust authentication and authorization systems for controlling access to resources and protecting sensitive information.

### Secrets management

Secrets are the keys to your infrastructure. Compromised credentials can bypass all other security controls, making secrets management essential for protecting against credential-based attacks and ensuring secure application deployment. This section covers secrets storage, rotation, access control, and audit logging practices. These practices help you securely store, distribute, and manage sensitive information such as passwords, API keys, and certificates.

### Data security

Data is often the most valuable asset organizations protect. Data breaches can have severe financial, legal, and reputational consequences, making data security practices critical for comprehensive protection. This section covers data encryption, backup security, data loss prevention, and data classification practices. These practices help you protect data at rest and in transit through encryption, access controls, and data classification throughout its lifecycle.

### Secure applications

Applications are the primary attack surface for most organizations. Without secure application development practices, vulnerabilities in code can undermine all infrastructure security controls and provide attackers with direct access to systems and data. This section covers secure coding practices, vulnerability management, and application security testing. These practices help you build security into applications from design through deployment.

### Compliance and governance

Compliance requirements drive many security decisions. Without proper governance and compliance practices, organizations risk regulatory penalties and may implement security controls that do not align with business objectives or provide effective protection. This section covers compliance frameworks, audit trails, and governance processes. These processes help you establish security policies, procedures, and monitoring for compliance with regulations and standards.

### Network security

Network security provides the perimeter defense that prevents initial compromise. Without proper network security controls, attackers can easily gain access to infrastructure and move laterally to compromise additional systems and data. This section covers network segmentation, firewalls, intrusion detection, and lateral movement prevention practices. These practices help you implement network-level security controls to prevent unauthorized access and lateral movement within infrastructure.

## Next steps

In this overview, you learned about securing systems. Securing systems is part of the [Well-Architected Framework](/well-architected-framework).

Refer to the following documents to learn how to secure systems.

- [Identity and access management](/well-architected-framework/secure-systems/identity-access-management) to implement robust authentication and authorization
- [Secrets management](/well-architected-framework/secure-systems/secrets) to securely manage sensitive credentials and configuration
- [Data security](/well-architected-framework/secure-systems/data) to protect data throughout its lifecycle
- [Secure applications](/well-architected-framework/secure-systems/secure-applications) to build security into application development
- [Compliance and governance](/well-architected-framework/secure-systems/compliance-and-governance) to establish security governance and compliance
- [Prevent lateral movement](/well-architected-framework/secure-systems/prevent-lateral-movement) to implement network security controls