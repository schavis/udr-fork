...
In this section of how to [secure secrets](/well-architected-framework/secure-systems/secrets), you learned about how to store static secrets in your organization. Storing static secrets is part of the [Secure systems pillar](/well-architected-framework/secure-systems/introduction).
