---
page_title: Verify HashiCorp binary downloads
description: >-
  Learn how to install and verify HashiCorp tools for any Linux distribution.
  Download, verify, and install HashiCorp's PGP public key. Download a
  HashiCorp product archive and signed checksum. Verify that the binary matches
  the checksum file.
---
