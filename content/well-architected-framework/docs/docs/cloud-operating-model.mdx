...
![Cloud operating model](/img/well-architected/com-hashicorp-stack-app-delivery.png)
...
![Static to dynamic infrastructure](/img/well-architected/commulti-cloud-transition-2x.png)
...
![Cloud Operating Model layers](/img/well-architected/com-static-dynamic-run-connect-secure-provision.png)
