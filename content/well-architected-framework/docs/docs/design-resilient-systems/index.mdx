...
This pillar covers four main areas that work together to create comprehensive system resilience:

- **Distributed systems principles** provide the foundational concepts and patterns for building fault-tolerant architectures, including fault isolation, redundancy, and secure distributed systems design.

- **High availability and failover** covers the mechanisms and strategies for maintaining service availability during component failures, including planning for resiliency and automated failover mechanisms.

- **Disaster recovery** focuses on planning and procedures for catastrophic failure scenarios, including backup strategies, recovery time objectives, and disaster recovery testing.

- **Performance and scaling** ensures that resilient systems can handle increased load without compromising availability, including performance optimization practices and capacity planning.

### Distributed systems principles

These topics provide the foundational knowledge needed to design systems that can withstand failures. Without understanding these principles, you cannot build truly resilient architectures that maintain availability during component failures. This section covers fault isolation, redundancy, eventual consistency, and secure distributed systems design patterns. These principles help you understand and implement core concepts for building resilient distributed systems in modern architectures.

### High availability and failover

These topics represent the practical implementation of resilience. High availability and failover are the core mechanisms that transform theoretical resilience concepts into operational reality that maintains business continuity. This section covers planning for resiliency, automated failover mechanisms, and various failover strategies including active-passive and active-active configurations. These mechanisms help you implement redundancy and failover to ensure continuous service availability.

### Disaster recovery

These topics address the most severe failure scenarios that could impact business operations. Disaster recovery planning ensures that even catastrophic events do not result in permanent data loss or extended service outages. This section covers backup strategies, recovery time objectives, disaster recovery testing, and procedures. These procedures help you establish comprehensive disaster recovery and backup strategies for protecting against catastrophic failures.

### Performance and scaling

Resilient systems must also perform well under normal conditions. Without proper performance optimization, resilient architectures may be reliable but unusable, failing to meet business requirements for responsiveness and throughput. This section covers performance optimization practices, capacity planning, and scaling strategies. These strategies help you optimize system performance while maintaining resilience to ensure systems can handle increased load without compromising availability.

## Next steps

In this overview, you learned about designing resilient systems. Designing resilient systems is part of the [Well-Architected Framework](/well-architected-framework).

Refer to the following documents to learn how to design resilient systems.

- [Distributed systems principles](/well-architected-framework/design-resilient-systems/distributed-systems-principles) to understand core concepts for resilient architectures
- [Plan for resiliency and availability](/well-architected-framework/design-resilient-systems/plan-for-resiliency-and-availability) to design high-availability architectures
- [Failover](/well-architected-framework/design-resilient-systems/failover) to implement automated failover mechanisms
- [Disaster recovery](/well-architected-framework/design-resilient-systems/disaster-recovery) to establish comprehensive disaster recovery procedures
- [Scale and tune performance](/well-architected-framework/design-resilient-systems/scale-and-tune-performance) to optimize performance while maintaining resilience
