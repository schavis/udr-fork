...
This pillar covers three main areas that work together to create comprehensive system resilience:
...
- **Ensure high availability** covers the mechanisms and strategies for maintaining service availability during component failures, including disaster recovery planning and automated failover mechanisms.

- **Optimize performance** ensures that resilient systems can handle increased load without compromising availability, including performance optimization practices and capacity planning.

### Principles

These topics provide the foundational knowledge needed to design systems that can withstand failures. Without understanding these principles, you cannot build truly resilient architectures that maintain availability during component failures. This section covers distributed systems principles and planning for resilience. These principles help you understand and implement core concepts for building resilient distributed systems in modern architectures.

### Ensure high availability

These topics represent the practical implementation of resilience. High availability and disaster recovery are the core mechanisms that transform theoretical resilience concepts into operational reality that maintains business continuity. This section covers disaster recovery planning and automated failover mechanisms. These mechanisms help you implement redundancy and failover to ensure continuous service availability.

### Optimize performance

Resilient systems must also perform well under normal conditions. Without proper performance optimization, resilient architectures may be reliable but unusable, failing to meet business requirements for responsiveness and throughput. This section covers performance optimization practices and capacity planning. These strategies help you optimize system performance while maintaining resilience to ensure systems can handle increased load without compromising availability.
...
- [Principles](/well-architected-framework/design-resilient-systems/principles) to understand core concepts for resilient architectures
- [Ensure high availability](/well-architected-framework/design-resilient-systems/ensure-high-availability) to implement high-availability and disaster recovery mechanisms
- [Optimize performance](/well-architected-framework/design-resilient-systems/optimize-performance) to optimize performance while maintaining resilience
