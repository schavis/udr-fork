...
- [Plan disaster recovery](/well-architected-framework/design-resilient-systems/ensure-high-availability/plan-disaster-recovery) to implement disaster recovery procedures
...
- [What is zero trust security and zero trust networking?](/well-architected-framework/security/security-zero-trust-video) - Guide to zero trust networking principles
