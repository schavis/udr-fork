...
In this article, you learned about scaling and tuning performance in fault-tolerant systems, including implementing bulkheads and circuit breakers, optimizing caching and state management, monitoring and adapting to system conditions, and testing and validating system behavior.
...
- [Distributed systems principles](/well-architected-framework/design-resilient-systems/principles/distributed-systems-principles) to understand fundamental resiliency concepts
- [Tune performance](/well-architected-framework/design-resilient-systems/optimize-performance/tune-performance) to optimize system performance
...
- [React to metrics and monitoring](/well-architected-framework/reliability/reliability-react-to-monitoring) - Guide to monitoring and metrics
- [Manage infrastructure and service monitoring](/well-architected-framework/reliability/reliability-deploy-application-monitoring-components) - Guide to monitoring components
