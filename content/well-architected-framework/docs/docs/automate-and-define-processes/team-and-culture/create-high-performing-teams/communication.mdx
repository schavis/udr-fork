...
In this section of how to [Create high-performing teams](/well-architected-framework/automate-and-define-processes/create-high-performing-teams), you learned about tools to increase team communication. Creating high performing teams is part of the [Automate and define processes pillar](/well-architected-framework/automate-and-define-processes).
