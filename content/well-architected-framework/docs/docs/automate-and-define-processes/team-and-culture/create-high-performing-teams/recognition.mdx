...
In this section of how to [Create high-performing teams](/well-architected-framework/automate-and-define-processes/create-high-performing-teams/overview), you learned about showing recognition for team members' work. Creating high performing teams is part of the [Automate and define processes pillar](/well-architected-framework/automate-and-define-processes).
