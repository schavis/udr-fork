...
In this section of how to [Create high-performing teams](/well-architected-framework/automate-and-define-processes/create-high-performing-teams/overview), you learned about writing tools to help your team collaborate, share thoughts, and solve problems. Creating high performing teams is part of the [Automate and define processes pillar](/well-architected-framework/automate-and-define-processes).
