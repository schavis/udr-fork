...
In this section of [Automate deployments](/well-architected-framework/automate-and-define-processes/develop-and-deploy/automate-deployments/overview), you learned best practices for implementing fully-automated deployments. Automate deployments is part of the [Automate and define processes pillar](/well-architected-framework/automate-and-define-processes/introduction).