...
description: Learn how to use infrastructure as code to automate and define processes.
---
...
In this overview, you learned what infrastructure as code (IaC) is how you can deploy IaC with Terraform. You can now learn how to use IaC to manage your CI/CD, container orchestration, and other tools by visiting the following documents. Use infrastructure as code is part of the [Automate and define processes pillar](/well-architected-framework/automate-and-define-processes/introduction.mdx).

- [Continuous integration/deployment (CI/CD) systems](/well-architected-framework/automate-and-define-processes/use-infrastructure-as-code/manage-tools/ci-cd)
- [Public cloud and cloud automation](/well-architected-framework/automate-and-define-processes/use-infrastructure-as-code/manage-tools/cloud-automation)
- [Container orchestration](/well-architected-framework/automate-and-define-processes/use-infrastructure-as-code/manage-tools/container-orchestration) like Kubernetes, Nomad, and cloud-native container services
- [Database systems and components](/well-architected-framework/automate-and-define-processes/use-infrastructure-as-code/manage-tools/database)
- [Logging and monitoring](/well-architected-framework/automate-and-define-processes/use-infrastructure-as-code/manage-tools/logging-and-monitoring)
- [Security and authentiation](/well-architected-framework/automate-and-define-processes/use-infrastructure-as-code/manage-tools/security-and-authentication)
- [Version control systems (VCS)](/well-architected-framework/automate-and-define-processes/use-infrastructure-as-code/manage-tools/version-control-systems) like GitHub, GitLab, and Bitbucket
