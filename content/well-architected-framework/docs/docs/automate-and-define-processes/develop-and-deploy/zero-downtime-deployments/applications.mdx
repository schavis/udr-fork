...
description: Learn how to deploy applications with zero downtime.
---
...
![Canary test/deployment. All traffic is directed to the blue environment initially. When you perform a canary test, 10% of the traffic is directed to the green environment.](/img/docs/well-architected-framework/blue-green-canary-tests-deployments/canary-deployment.png)
...
![Rolling deployment. After the initial canary test, traffic to the green environment is split evenly with the blue environment (50/50). Finally, all traffic is directed to the green environment.](/img/docs/well-architected-framework/blue-green-canary-tests-deployments/rolling-deployment.png)
...
In this section of [Zero-downtime deployments](/well-architected-framework/automate-and-define-processes/develop-and-deploy/zero-downtime-deployments), you learned about methods to deploy application changes with zero-downtime. Zero-downtime deployments is part of the [Automate and define processes pillar](/well-architected-framework/automate-and-define-processes).
