...
In this section of [Zero-downtime deployments](/well-architected-framework/automate-and-define-processes/develop-and-deploy/zero-downtime-deployments/overview), you learned about methods to deploy infrastructure changes with zero-downtime. Zero-downtime deployments is part of the Automate and define processes pillar.