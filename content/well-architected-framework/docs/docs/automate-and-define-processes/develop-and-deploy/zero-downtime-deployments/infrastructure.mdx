...
description: Learn how to deploy infrastructure with zero downtime.
---
...
## How to deploy blue/green infrastructure
...
![Typical blue green deployment. The green environment runs in parallel with the blue environment. When you are ready to switch to the green environment the load balancer directs traffic to the green environment.](/img/docs/well-architected/blue-green-canary-tests-deployments/blue-green-deployment.png)
