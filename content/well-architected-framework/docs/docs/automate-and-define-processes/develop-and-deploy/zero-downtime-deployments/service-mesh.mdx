...
description: Learn how to use service splitters to deploy infrastructure and applications with zero downtime.
---
...
In this section of how to [Develop and deploy](link), you learned how to use service mesh to deploy with zero-downtime. Develop and deploy is part of the [Automate and define processes](link) pillar.

In this section of [Zero-downtime deployments](/well-architected-framework/automate-and-define-processes/develop-and-deploy/zero-downtime-deployments/overview), you learned how to use service mesh to deploy with zero-downtime. Zero-downtime deployments is part of the Automate and define processes pillar.
