...
In this section of [Zero-downtime deployments](/well-architected-framework/automate-and-define-processes/develop-and-deploy/zero-downtime-deployments), you learned how to use service mesh to deploy with zero-downtime. Zero-downtime deployments is part of the [Automate and define processes pillar](/well-architected-framework/automate-and-define-processes).
