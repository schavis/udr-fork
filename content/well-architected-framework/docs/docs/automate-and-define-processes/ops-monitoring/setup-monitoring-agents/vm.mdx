...
In this section of [Setup monitoring agents](/well-architected-framework/automate-and-define-processes/ops-monitoring/setup-monitoring-agents), you learned how to configure and deploy monitoring agents on virtual machines. Setting up monitoring agents is part of the [Automate and define processes pillar](/well-architected-framework/automate-and-define-processes/introduction).