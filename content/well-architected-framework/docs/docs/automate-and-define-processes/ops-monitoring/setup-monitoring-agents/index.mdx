...
In this overview, you learned about monitoring agents and the high-level workflow. Setting up monitoring agents is part of the [Automate and define processes pillar](/well-architected-framework/automate-and-define-processes).
