...
In this overview, you learned about monitoring agents and the high-level workflow. Setting up monitoring agents is part of the [Automate and define processes pillar](/well-architected-framework/automate-and-define-processes/introduction).

Refer to the following documents to learn how to configure and deploy monitoring agents.

- [Manage monitoring agents secrets](/well-architected-framework/automate-and-define-processes/ops-monitoring/setup-monitoring-agents/manage-secrets)
- [Configure and deploy your monitoring agent on VMs](/well-architected-framework/automate-and-define-processes/ops-monitoring/setup-monitoring-agents/vm)
- [Configure and deploy your monitoring agent on container orchestrators](/well-architected-framework/automate-and-define-processes/ops-monitoring/setup-monitoring-agents/containers)
- [Platform-agnostic monitoring through service mesh](/well-architected-framework/automate-and-define-processes/ops-monitoring/setup-monitoring-agents/service-mesh)