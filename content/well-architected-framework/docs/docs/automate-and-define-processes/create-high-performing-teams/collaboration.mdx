...
In this section of how to [create high-performing teams](/well-architected-framework/automate-and-define-processes/create-high-performing-teams/overview), you learned about methods to increase team collaboration. Creating high performing teams is part of the Automate and define processes pillar.
