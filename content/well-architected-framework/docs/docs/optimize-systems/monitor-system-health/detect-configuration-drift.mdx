...
In this article, you learned about implementing automated drift detection and health monitoring, including configuring automated detection, implementing custom health conditions, and monitoring and responding to drift.

Refer to the following documents to learn more about infrastructure monitoring:

- [Identify common metrics](/well-architected-framework/optimize-systems/monitor-system-health/measure-performance-metrics/identify-metrics) to monitor the right performance indicators
- [Monitor network traffic](/well-architected-framework/optimize-systems/monitor-system-health/measure-performance-metrics/monitor-network) to track network performance and connectivity
