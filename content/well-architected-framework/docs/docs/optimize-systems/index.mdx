...
description: Learn how to optimize your systems for efficiency and cost-effectiveness.
---
...
This pillar covers three main areas that work together to create a comprehensive system optimization strategy:

- **Measure performance** establishes the foundation for understanding system behavior and identifying optimization opportunities, including infrastructure monitoring, service monitoring, and network monitoring.

- **Scale** covers the strategies and tools for dynamically adjusting resources based on demand, including container scaling, application scaling, and infrastructure scaling.

- **Detect drift** ensures that systems remain in the desired state and configuration changes are tracked and managed, including resource drift detection and security compliance management.

### Measure performance

Optimization without measurement is guesswork. You need comprehensive visibility into system behavior to make data-driven decisions about resource allocation and identify areas for improvement. This section covers infrastructure monitoring, service monitoring, and network monitoring practices. These practices help you establish the foundation for effective system optimization by providing the metrics and insights necessary for understanding performance across all components.

### Scale

These topics represent the core mechanisms for achieving cost optimization while maintaining performance. Without proper scaling strategies, you either over-provision resources (wasting money) or under-provision (compromising performance). This section covers container scaling, application scaling, and infrastructure scaling practices. These practices help you implement dynamic scaling strategies to automatically adjust resources based on actual demand patterns.

### Detect drift

Configuration drift undermines optimization efforts by causing systems to deviate from their intended configuration, which leads to performance degradation, increased costs, and security vulnerabilities. This section covers resource drift detection and security compliance management practices. These practices help you automatically identify and remediate configuration drift to maintain system consistency and security.
...
- [Measure performance](/well-architected-framework/optimize-systems/measure-performance) to establish comprehensive monitoring and metrics collection
- [Scale](/well-architected-framework/optimize-systems/scale) to implement dynamic scaling strategies and capacity planning
- [Detect drift](/well-architected-framework/optimize-systems/detect-drift) to identify and remediate configuration drift automatically