...
- [Monitor system health](/well-architected-framework/optimize-systems/monitor-system-health) to establish comprehensive monitoring and metrics collection
- [Scale resources](/well-architected-framework/optimize-systems/scale-resources) to implement dynamic scaling strategies and capacity planning