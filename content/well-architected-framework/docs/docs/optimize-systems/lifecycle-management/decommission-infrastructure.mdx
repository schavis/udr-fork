...
If you're using HCP Terraform, you can use the [workspace explorer](/terraform/cloud-docs/workspaces/explorer) feature to see all resources your organization manages with Terraform. The explorer visualizes your infrastructure, helping you identify unused resources.
