...
To successfully decommission resources, you need to create a well-defined plan that includes dependency analysis, stakeholder communication, and a gradual removal process. Depending on your infrastructure implementation, such as if you manually or automate your infrastructure creation, you may need to adjust your decommissioning approach.
...
The following are some resources you may want to back up:
