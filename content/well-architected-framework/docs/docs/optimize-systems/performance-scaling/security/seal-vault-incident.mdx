...
In this section of [Security and compliance](/well-architected-framework/optimize-systems/performance-scaling/security), you learned about sealing Vault during a security incident. Security and compliance is part of the [Optimize systems pillar](/well-architected-framework/optimize-systems).