...
- [Define and automate processes](/well-architected-framework/docs/docs/define-and-automate-processes)
- [Secure systems](/well-architected-framework/docs/docs/secure-systems)
- [Optimize systems](/well-architected-framework/docs/docs/optimize-systems)
