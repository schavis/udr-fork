...
![HashiCorp Stack Value](/img/docs/well-architected-framework/commaturity2020x.png)
...
HashiCorp Well-Architected Framework is comprised of pillars. Each pillar contains groupings of best practices.

- [Automate and define processes](/well-architected-framework/docs/docs/automate-and-define-processes)
- [Optimize resources](/well-architected-framework/docs/docs/optimize-resources)
- [Design resilient systems](/well-architected-framework/docs/docs/design-resilient-systems)
- [Secure systems](/well-architected-framework/docs/docs/secure-systems)
