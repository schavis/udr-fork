...
Do not use metaphors, similes, colloquialisms, idiomatic expressions, or other figurative language. Refer to [Do not use words or phrases borrowed from other languages, scientific words, or jargon words](TODO) for more guidance. 
...
Refer to localhost, instead of IPv4 or IPv6 addresses, when describing a locally addressable web service. Refer to [Format IP addresses as code](TODO) for additional guidance.
...
Refer to [Appendix B: Metadata](TODO) in the content types guidance for additional information.
