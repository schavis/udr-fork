...
> **Note**: Fields labeled with "# Not collected in this release" will be collected in an upcoming release.
```json
{
    "version":"2",
    "mode": "automatic",
    ...
    "snapshots":[
      {
        ...
        "metrics": {
            ...
            "deployment_option": { # Not collected in this release
            ...
            "operational_mode": { # Not collected in this release
            ...
            "workspaces_count_continuous_validation": { # Not collected in this release
                "key": "workspaces_count_continuous_validation",
                "value": 0,
                "mode": "write"
            },
            "workspaces_count_drift_detection": { # Not collected in this release
                "key": "workspaces_count_drift_detection",
                "value": 0,
                "mode": "write"
            },
            "workspaces_count_no_code_modules": { # Not collected in this release
                "key": "workspaces_count_no_code_modules",
                "value": 0,
                "mode": "write"
            },
            "workspaces_count_notifications_enabled": { # Not collected in this release
                "key": "workspaces_count_notifications_enabled",
                "value": 0,
                "mode": "write"
            },
            "workspaces_count_opa_policy_sets": { # Not collected in this release
            ...
            "workspaces_count_sentinel_policy_sets": { # Not collected in this release
