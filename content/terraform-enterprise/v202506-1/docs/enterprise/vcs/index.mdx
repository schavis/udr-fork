...
-   [Azure DevOps Services (OAuth)](/terraform/enterprise/vcs/azure-devops-services)
-   [Azure DevOps Services (PAT)](/terraform/enterprise/vcs/azure-devops-services-pat)
