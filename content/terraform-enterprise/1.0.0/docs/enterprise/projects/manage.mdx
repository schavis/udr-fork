...
By default, a project uses the organization's execution mode. You can enable the **Remote** or **Local** execution mode option for an organization. You can override the organization execution mode in your project. Any workspaces created in the project after changing the project execution mode inherit the project default.
