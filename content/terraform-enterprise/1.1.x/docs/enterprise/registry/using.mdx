...
-   **Authentication:** If you run Terraform on the command line, you must [authenticate](#authentication-configurations-with-private-providers-and-modules) to HCP Terraform or your instance to use providers and modules in your organization’s private registry.
