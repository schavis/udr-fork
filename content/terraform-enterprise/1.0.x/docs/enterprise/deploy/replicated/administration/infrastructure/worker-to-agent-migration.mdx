...
| ------------------------- | ----------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| Building a custom image   | [Documentation](/terraform/enterprise/install/interactive/installer#alternative-terraform-worker-image) | [Documentation](/terraform/cloud-docs/agents/agents#optional-configuration-run-an-agent-using-docker)          |
