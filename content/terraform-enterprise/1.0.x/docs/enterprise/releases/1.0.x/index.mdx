...
2. (Updated 09/19/2025) The Terraform Enterprise API must include the value of the `x-tfe-version` header in its response. This header indicates the current version of Terraform Enterprise. 
