...
## Known Issues
1. (Updated 08/15/2025) You may experience failures when using an S3-compatible storage solution. A library was upgraded that is triggering authentication issues with some 3rd party storage solutions. Errors may arise when running plans and applies, or when accessing terraform state files. More detailed information about this issue can be found on the [aws sdk github issues page](https://github.com/aws/aws-sdk-go-v2/discussions/2960). This issue will be resolved in an upcoming patch release. 
