...
1.  **[Configure HCP](#configure-hcp):** Set up a trust configuration between HCP and HCP Terraform. Then, you must create a [service principal in HPC](/hcp/docs/hcp/admin/iam/service-principal) for your HCP Terraform workspaces.
