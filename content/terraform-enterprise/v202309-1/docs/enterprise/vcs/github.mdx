...
For beginning users on Terraform Cloud, we recommend using our [configuration-free GitHub App](/terraform/enterprise/vcs/github-app) to access repositories instead.
