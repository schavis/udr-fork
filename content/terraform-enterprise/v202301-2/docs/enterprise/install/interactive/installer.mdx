...
Before you begin, consult the [Pre-Install Checklist](/enterprise/before-installing) for prerequisites. You'll need to prepare data files and a Linux instance.
