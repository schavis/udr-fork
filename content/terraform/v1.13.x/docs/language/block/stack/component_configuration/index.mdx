...
Each Stack requires at least one `component` block, and you must add a `component` block for every module you want to include in your Stack. Learn more about [creating Stacks](/terraform/language/stacks/create).
