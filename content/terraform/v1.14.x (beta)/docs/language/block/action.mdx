...
The `function_name` argument must reference an existing AWS Lambda function by name or ARN. Refer to the [`aws_lambda_invoke` documentation](https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/actions/lambda_invoke) for details.
