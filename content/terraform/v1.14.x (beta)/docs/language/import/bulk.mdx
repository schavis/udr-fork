...
All resources in this provider support `list` blocks. Because this provider is fully generated and doesn't accept provider-specific configurations, you can omit the `config` block when defining queries for AWS CC resources.  
