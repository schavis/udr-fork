...
- Use the [`deployment_auto_approve`](/terraform/language/block/stack/tfdeploy/deployment-auto-group ) block to define rules that automatically approve deployment plans based on specific conditions.
- Use the [`deployment_group`](/terraform/language/block/stack/tfdeploy/deployment-auto-group ) block to assign `deployment_auto_approve` rules to specific deployments.
