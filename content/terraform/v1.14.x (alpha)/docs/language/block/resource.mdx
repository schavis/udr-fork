...
Use the `action_trigger` block to invoke provider actions. The following table describes the arguments you can configure in the `action_trigger` block:
...
action "ansible_playbook" "provisio" {
  #...
}
```
