...
The `action_trigger` block directs Terraform to automatically invoke actions based on the conditions you specify. The following table describes the arguments you can configure in the `action_trigger` block:
