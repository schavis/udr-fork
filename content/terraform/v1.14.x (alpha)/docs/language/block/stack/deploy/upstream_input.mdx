...
A Stack can expose an output to other Stacks by defining a [`publish_output`](/terraform/language/block/stack/deployment/publish_output) blocks in its deployment configuration.
