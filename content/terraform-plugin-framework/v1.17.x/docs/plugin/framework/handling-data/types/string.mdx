...
created_at: 2026-03-05T16:11:35.000Z
last_modified: 2026-03-05T16:11:35.000Z
...
String values can be added to all framework [schemas](/terraform/plugin/framework/handling-data/schemas) and [nested attribute types](/terraform/plugin/framework/handling-data/attributes#nested-attribute-types).
