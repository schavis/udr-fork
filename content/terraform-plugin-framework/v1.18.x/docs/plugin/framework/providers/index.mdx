...
created_at: 2026-03-05T16:12:51.000Z
last_modified: 2026-03-05T16:12:51.000Z
...
func (p *ExampleCloudProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
	...
	// Create data/clients and persist to resp.DataSourceData, resp.ResourceData, etc, as appropriate.
}
```
