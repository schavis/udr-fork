...
created_at: 2026-03-05T16:12:35.000Z
last_modified: 2026-03-05T16:12:35.000Z
...
When testing provider-defined functions with Terraform configuration, a corresponding [`required_provider`](/terraform/language/providers/requirements) entry is required for the provider under test.

Using the [`TestStep.Config`](https://pkg.go.dev/github.com/hashicorp/terraform-plugin-testing/helper/resource#TestStep.Config) field will automatically inject a `required_providers` entry, but for [`TestStep.ConfigFile`](https://pkg.go.dev/github.com/hashicorp/terraform-plugin-testing/helper/resource#TestStep.ConfigFile) and [`TestStep.ConfigDirectory`](https://pkg.go.dev/github.com/hashicorp/terraform-plugin-testing/helper/resource#TestStep.ConfigDirectory) the provider
developer needs to add the `required_provider` block in their test configuration.
