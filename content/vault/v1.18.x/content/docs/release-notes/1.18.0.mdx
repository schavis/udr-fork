...
| Known issue (1.18.0-1.19.6) | [Counters API requires start_time parameter in OSS Vault](/vault/docs/upgrading/upgrade-to-1.18.x#counters-api-requires-start-time-in-oss-vault) |
