...
- `max_connection_lifetime` `(string: "0s")` - Specifies the maximum amount of
  ...
  connection reusable forever. Snowflake limits the default session policy for
  connections at 4 hours before being renewed unless you
  [change the session policy definition](https://docs.snowflake.com/en/user-guide/session-policies#session-policies).
