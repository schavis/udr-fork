...
If you use `file` audit devices, you may need to:

1. Add `allow_audit_log_prefixing = true` to your Vault server configuration if using the `prefix` option.
2. Use non-executable file modes (e.g., 0644, 0666).
