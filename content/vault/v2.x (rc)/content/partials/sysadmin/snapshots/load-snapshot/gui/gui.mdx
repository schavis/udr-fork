...
1. Log in under the `root` namespace. While you can perform other snapshot
   operations from any namespace, you must perform load and unload operations
	 under the `root` namespace.

1. Select **Secrets** from the left-hand menu.

1. Select **Secrets Recovery** from the submenu.
