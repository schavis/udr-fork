...
| `vault.scim.config.clients.count`                                   | The total number of distinct SCIM clients configured.                                                            |
| `vault.scim.config.clients.with_mount_accessor.count`               | The total number of SCIM clients with a mount accessor configured.                                               |
| `vault.scim.resources.entities_managed.count`                       | The total number of identity entities under SCIM management.                                                     |
| `vault.scim.resources.groups_managed.count`                         | The total number of identity groups under SCIM management.                                                       |
