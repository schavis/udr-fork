...
1. Log in under the admin or root namespace or select the namespace from the
   selector at the bottom of the left-hand menu and re-authenticate.
1. Select **Operational tools** from the left-hand menu.
1. Select **Custom messages** from the submenu.
1. Select **UI Login Settings**.
1. Click on a customization entry from the list of existing login settings to view the rule details.
