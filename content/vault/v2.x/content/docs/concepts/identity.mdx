...
Vault Enterprise also supports beta SCIM provisioning for workflows that create
and manage entities and internal groups from external identity
platforms. Refer to the [SCIM API guide](/vault/docs/enterprise/scim-overview)
for the supported behavior and limits.
