...
@include '../../../global/partials/tables/compare/east-west.mdx'

## Guidance

@include '../../../global/partials/text/guidance/east-west/cluster-peering.mdx'

## Basic troubleshooting

@include '../../../global/partials/text/limitations/east-west/cluster-peering.mdx'