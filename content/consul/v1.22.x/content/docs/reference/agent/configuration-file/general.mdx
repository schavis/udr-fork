...
- `http_config` This object allows setting options for the HTTP API and UI.
  ...
  - `write_timeout` The maximum duration before timing out writes of the response. This timeout prevents slow response drain attacks. A zero or negative value disables the timeout. Default: `30s`. Minimum: `1s`. Added in Consul v1.22.4.
