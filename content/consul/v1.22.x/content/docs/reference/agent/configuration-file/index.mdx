...
last_modified: 2026-03-07T00:13:38.000Z
...
@include '../../../global/partials/examples/agent/server/encrypted.mdx'

@include '../../../global/partials/examples/agent/server/service-mesh.mdx'

@include '../../../global/partials/examples/agent/client/multi-interface.mdx'

@include '../../../global/partials/examples/agent/client/register-service.mdx'
