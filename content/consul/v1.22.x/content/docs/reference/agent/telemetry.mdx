...
last_modified: 2026-02-17T15:55:20.000Z
...
The finite-state-machine captures the behavior of the Raft index. These metrics measure the amount of time it takes to apply a given event to the FSM.
...
| `consul.consul.peering.healthy`           | Deprecated - please use `peering_healthy`.                                                                                                                                       | health   | gauge   |
