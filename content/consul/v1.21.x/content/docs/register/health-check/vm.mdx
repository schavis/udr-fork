...
!> **Security warning:** Consul's HTTP checks can be configured by administrators to access local networks, potentially exposing information of internal network services accessible to Consul to administrators.
